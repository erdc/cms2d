...
!*************************************************************     
    ...
    select case(cardname)
      ...
      case('INITIAL_STARTUP_FILE','INITIAL_CONDITION_FILE', 'HOT_START_SIMULATION')  !If another is added to the list, modify the appropriate line in 'input.F90' for subroutine 'card_dataset'
